...
class _PaymentVerificationViewState extends State<PaymentVerificationView> {
  ...
  void _showRefundDialog(PaymentEntity payment) {
    if (Navigator.canPop(context))
      Navigator.pop(context); // Menutup dialog verifikasi sebelumnya
      ...
      builder: (ctx) {
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              const Text(
                'Perhatian: Fitur ini akan mengembalikan dana ke saldo rekening (Midtrans) pengguna secara otomatis.',
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                context.read<PaymentVerificationBloc>().add(
                  RefundPaymentEvent(
  ...
  void _showVerificationDialog(PaymentEntity payment) {
    ...
    showDialog(
      ...
      builder: (ctx) {
        return AlertDialog(
          title: Text(
            'Verifikasi Pembayaran #${payment.transactionId ?? payment.id}',
          ),
            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                  const Text(
                    'Catatan Penolakan (Wajib jika ditolak):',
              ...
              onPressed: () {
                if (notesController.text.trim().isEmpty) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text(
                        'Catatan wajib diisi jika Anda menolak pembayaran!',
                      ),
                    ),
                  );
                  return;
  ...
  @override
  Widget build(BuildContext context) {
    return BlocListener<PaymentVerificationBloc, PaymentVerificationState>(
      ...
      child: Scaffold(
        appBar: AppBar(title: const Text('Verifikasi Pembayaran Manual')),
        body: Padding(
          padding: const EdgeInsets.all(24.0),
          child: BlocBuilder<PaymentVerificationBloc, PaymentVerificationState>(
            buildWhen: (prev, current) =>
                current is PaymentVerificationLoading ||
                current is PaymentVerificationLoaded,
                    ...
                    return Padding(
                      ...
                      child: BasicCard(
                        child: ListTile(
                          ...
                          title: Text(
                            'Transaksi #${payment.transactionId ?? payment.id}',
